...
VALUES
  ('Dimitrios Papadopoulos'::varchar(255), NOW(), NOW(), true, false, '{1, 3, 5}'::INTEGER[],
    ST_SetSRID(ST_MakePoint(40.642480,22.948253), 4326)),
  ('Eleni Karadimitriou'::varchar(255), NOW(), NOW(), false, true, '{2, 4, 6}'::INTEGER[],
    ST_SetSRID(ST_MakePoint(40.637064,22.947696), 4326)),
  ('Giorgos Konstantinidis'::varchar(255), NOW(), NOW(), true, true, '{1, 2, 3}'::INTEGER[],
    ST_SetSRID(ST_MakePoint(40.639756,22.939905), 4326)),
  ('Maria Vasileiadou'::varchar(255), NOW(), NOW(), false, false, '{6, 3, 4}'::INTEGER[],
    ST_SetSRID(ST_MakePoint(40.629958,22.951077), 4326)),
  ('Nikolaos Christodoulou'::varchar(255), NOW(), NOW(), true, false, '{2, 1, 4}'::INTEGER[],
    ST_SetSRID(ST_MakePoint(40.644345,22.964067), 4326)),
  ('Anastasia Ioannidou'::varchar(255), NOW(), NOW(), false, true, '{5, 1, 6}'::INTEGER[],
    ST_SetSRID(ST_MakePoint(40.660638,22.963444), 4326)),
  ('Theodoros Makridis'::varchar(255), NOW(), NOW(), true, true, '{2, 1, 3}'::INTEGER[],
    ST_SetSRID(ST_MakePoint(40.689271,22.954450), 4326)),
  ('Katerina Alexiou'::varchar(255), NOW(), NOW(), false, false, '{4, 5, 6}'::INTEGER[],
    ST_SetSRID(ST_MakePoint(40.712822,22.930555), 4326)),
  ('Panagiotis Spanopoulos'::varchar(255), NOW(), NOW(), false, true, '{5, 1, 2}'::INTEGER[],
    ST_SetSRID(ST_MakePoint(40.600125,22.961625), 4326)),
  ('Sofia Papageorgiou'::varchar(255), NOW(), NOW(), true, false, '{4, 1, 5}'::INTEGER[],
